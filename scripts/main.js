...
// Project overlay code removed since cards contain all details and link directly to external outputs.
...
window.addEventListener('scroll', () => {
    ...
    if (scrollPos > sectionTop - 500 && scrollPos < sectionTop + sectionHeight) {
        ...
        const index = Math.min(Math.floor(relativePos * images.length), images.length - 1);
